...
window.deprecationWorkflow.config = {
  workflow: [
    ...
    { handler: "throw", matchMessage: "Using the context switching form of {{each}} is deprecated. Please use the keyword form (`{{#each items as |item|}}`) instead." },
    ...
    { handler: "throw", matchMessage: "Usage of `submit_button` is deprecated, use `submitButton` instead." },
    ...
    { handler: "throw", matchMessage: "You attempted to access `errors` from `<hospitalrun@controller:patients/edit::ember1079>`, but object proxying is deprecated. Please use `model.errors` instead." },
