...
- Discharge report - use the examiner field from the visit. [\#1014](https://github.com/HospitalRun/hospitalrun-frontend/issues/1014)
...
- Examining Inventory across the network [\#125](https://github.com/HospitalRun/hospitalrun-frontend/issues/125)
...
- add custom form for labs [\#1009](https://github.com/HospitalRun/hospitalrun-frontend/pull/1009) ([baoqchau](https://github.com/baoqchau))
...
- Validate Medication module [\#161](https://github.com/HospitalRun/hospitalrun-frontend/issues/161)
...
- ember-cli-sass@5.2.1 breaks build 🚨 [\#241](https://github.com/HospitalRun/hospitalrun-frontend/pull/241) ([greenkeeperio-bot](https://github.com/greenkeeperio-bot))
...
- Add a category field to Inventory [\#111](https://github.com/HospitalRun/hospitalrun-frontend/issues/111)
...
- Change Surgery Visit Type to Admission [\#38](https://github.com/HospitalRun/hospitalrun-frontend/issues/38)
...
- Example of config.js [\#101](https://github.com/HospitalRun/hospitalrun-frontend/issues/101)
- Disabled save button is bad UX [\#98](https://github.com/HospitalRun/hospitalrun-frontend/issues/98)
- Remove charges section from labs and imaging [\#89](https://github.com/HospitalRun/hospitalrun-frontend/issues/89)
- Remove Adjust Purchases checkbox on inventory adjustment [\#85](https://github.com/HospitalRun/hospitalrun-frontend/issues/85)
- Batch input of inventory received [\#75](https://github.com/HospitalRun/hospitalrun-frontend/issues/75)
- Explore Foundation for Apps for possible Bootstrap replacement [\#26](https://github.com/HospitalRun/hospitalrun-frontend/issues/26)
- Add the list of diagnosis and procedures to the patient edit screen [\#25](https://github.com/HospitalRun/hospitalrun-frontend/issues/25)
- jglovier shiplist \[9/26\] GOAL: FutureStack 10/8 [\#24](https://github.com/HospitalRun/hospitalrun-frontend/issues/24)
- Beta site auth takes you back to select your Gmail account again after selecting first time [\#23](https://github.com/HospitalRun/hospitalrun-frontend/issues/23)
- change the .nav-category height to min-height [\#21](https://github.com/HospitalRun/hospitalrun-frontend/issues/21)
- jglovier ship list \[8/15\] [\#12](https://github.com/HospitalRun/hospitalrun-frontend/issues/12)
- Font on non retina display [\#10](https://github.com/HospitalRun/hospitalrun-frontend/issues/10)
- initial UI mock - Patients view [\#4](https://github.com/HospitalRun/hospitalrun-frontend/issues/4)
- Beef dat readme, yo [\#2](https://github.com/HospitalRun/hospitalrun-frontend/issues/2)
- Unable to start ember [\#1](https://github.com/HospitalRun/hospitalrun-frontend/issues/1)

**Merged pull requests:**

- Nav region style twerks [\#9](https://github.com/HospitalRun/hospitalrun-frontend/pull/9) ([jglovier](https://github.com/jglovier))
- Add Lato typeface [\#8](https://github.com/HospitalRun/hospitalrun-frontend/pull/8) ([jglovier](https://github.com/jglovier))
- UI tweaks [\#7](https://github.com/HospitalRun/hospitalrun-frontend/pull/7) ([jglovier](https://github.com/jglovier))
- Beef dat README \[WIP - not ready to merge yet\] [\#3](https://github.com/HospitalRun/hospitalrun-frontend/pull/3) ([jglovier](https://github.com/jglovier))
