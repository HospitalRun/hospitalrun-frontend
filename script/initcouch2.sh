...
curl -X PUT http://admin:admin@localhost:5984/_users/org.couchdb.user:tango -d '{"name": "tango", "password": "pezboy", "roles": ["System Administrator","admin","user"], "type": "user", "userPrefix": "p1"}'