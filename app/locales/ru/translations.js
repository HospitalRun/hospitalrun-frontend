export default {
  admin: {
    address: {
      address1Label: 'Адрес 1',
      address2Label: 'Адрес 2',
      address3Label: 'Адрес 3',
      address4Label: 'Адрес 4',
      addressLabel: 'Адрес',
      editTitle: 'Настройки адресов',
      include1Label: 'Вложение 1',
      include2Label: 'Вложение 2',
      include3Label: 'Вложение 3',
      include4Label: 'Вложение 4',
      messages: { addressSaved: 'Настройки адресов сохранены' },
      newTitle: 'Настройки адресов',
      titles: { optionsSaved: 'Настройки сохранены' }
    },
    addressOptions: 'Настройки адресов',
    customForms: {
      buttons: {
      ...
      labels: {
        alwaysInclude: 'Всегда Вкладывать',
        checkbox: 'Чекбокс',
        colSpan: 'Количество колонок для слияния',
        columns: 'Колонки',
        customForm: 'Особая форма',
        dischargeReportFormType: 'Отчет о Расходах',
        formName: 'Название Формы',
        formType: 'Тип Формы',
        incidentFormType: 'Инцидент',
        includeOtherOption: 'Включить другую опцию',
        labFormType: 'Лаборатория',
        label: 'Метка',
        newForm: 'Новая Форма',
        opdReportFormType: 'Амбулаторный Отчет',
        operativePlanFormType: 'Оперативный План и Отчет',
        otherOptionLabel: 'Метка других опций',
        patientFormType: 'Пациент',
        property: 'Свойство',
        radio: 'Радио',
        select: 'Список',
        socialworkFormType: 'Соц.работа',
        text: 'Текст',
