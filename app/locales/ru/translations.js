export default {
  ...
  admin: {
    address: {
      address1Label: 'Адрес 1 метка',
      address2Label: 'Адрес 2 метка',
      address3Label: 'Адрес 3 метка',
      address4Label: 'Адрес 4 метка',
      addressLabel: 'Адрес',
      editTitle: 'Параметры адреса',
      include1Label: 'включают 1 метка',
      include2Label: 'включают 2 метка',
      include3Label: 'включают 3 метка',
      include4Label: 'включают 4 метка',
    ...
    header: {
      ...
      facilityName: '',
      headerLabel: 'заголовок метка',
      headerLine1: 'заголовок линия 1',
      headerLine2: 'заголовок линия 2',
      headerLine3: 'заголовок линия 3',
