export default {
  ...
  admin: {
    ...
    lookup: {
      ...
      incidentLocations: 'Incident Locations',
  ...
  incident: {
    buttons: {
      ...
      generateSum: 'Generate Summary',
      newCategory: 'New Category',
      newFeedback: '+ new feedback',
      newFinding: '+ new investigation finding',
      newIncident: '+ new incident',
    ...
    labels: {
      ...
      communicationFactors: 'Communication Factors',
      ...
      description: 'Description',
      details: 'Details',
      educationalFactors: 'Educational and Training Factors',
      endDate: 'End Date',
      equipmentFactors: 'Equipment Factors',
      feedback: 'Feedback',
      givenBy: 'Given By',
      harmScore: 'HARM Score:',
      harmDuration: 'What is the anticipated duration of the harm to the individual?',
      harmPrompt: 'What is the extent of the harm to the individual at the time of the assessment?',
      idNumber: 'ID Number',
      idType: 'Identification Document Type',
      incidentCategory: 'Incident Type Category',
      incidentDate: 'Date of Incident',
      incidentDateSum: 'Incident Date:',
      incidentDesc: 'Incident Description',
      incidentId: 'Incident ID',
      incidentItem: 'Incident Type Item',
      incidentLocation: 'Location of Incident',
      incidentLocationSum: 'Location of Incident:',
      incidentType: 'Incident Type:',
      item: 'Item',
      lessonsLearned: 'Lessons Learned',
      narrativeStatement: 'Narrative Statement',
      ...
      riskScore: 'Risk Score = Severity * Occurrence',
      responsibility: 'Responsibility',
      reviewerEmail: 'Reviewer Email',
      reviewerName: 'Reviewer Name',
      rootCauseSummary: 'Root Cause Summary',
      severity: 'Severity',
      staffFactors: 'Staff Factors',
      startDate: 'Start Date',
      status: 'Status',
      targetDate: 'Target Date of Completion',
      taskFactors: 'Task Factors',
      teamFactors: 'Team Factors',
      typeOfPerson: 'Type of Person Involved',
      witness: 'Witness (Full Name)',
      workFactors: 'Work Environment Factors'
    },
    messages: {
    ...
    tabs: {
      ...
      preRisk: 'Pre-Incident Asst',
      postRisk: 'Post-Incident Asst',
      recommendations: 'Recommendations',
      reviewers: 'Reviewers',
    ...
    titles: {
      ...
      addFeedback: 'Add Feedback',
      addFinding: 'Add Investigation Finding',
      asReviewer: 'Incidents as Reviewer',
      cfcf: 'Contributory Factors Classification Framework',
      closed: 'Closed Incidents',
      current: 'Current',
      deleteFeedback: 'Delete Feedback',
      deleteFinding: 'Delete Investigation Finding',
      deleteItem: 'Delete Item',
      deleteRecommendation: 'Delete Recommendation',
      deleteReviewer: 'Delete Reviewer',
      editFeedback: 'Edit Feedback',
      editFinding: 'Edit Investigation Finding',
      editIncident: 'Edit Incident',
      editReviewer: 'Edit Reviewer',
      ...
      incidents: 'Incidents',
      newIncident: 'New Incident',
      preRisk: 'Pre-Incident Risk Assessment',
      postRisk: 'Post-Incident Risk Assessment',
