export default {
  admin: {
    address: {
      ...
      newTitle: 'Adresse Moglichkeit',
      titles: { optionsSaved: 'Optionen Gespeichert' }
    },
    addressOptions: 'Adressoptionen',
    customForms: {
      buttons: {
        addField: 'Hinzufugen Feld',
        moveDown: 'Bewegung Nieder',
        moveUp: 'Bewegung Oben',
        newForm: '+ neue form',
        preview: 'Vorschau'
      },
      labels: {
        alwaysInclude: 'Immer Enthalten',
        checkbox: 'Kontrollkastchen',
        colSpan: 'Anzahl von kolonnen nach spanne',
        columns: 'Kolonnen',
        customForm: 'Brauch Formular',
        dischargeReportFormType: 'Entladen Bericht',
        expenseTo: 'Ausgabe Nach',
        formName: 'Von Name',
        formType: 'Von Typus',
        incidentFormType: 'Vorfall',
        includeOtherOption: 'Enthalten Andere Moglichkeit',
        labFormType: 'Labor',
        label: 'Etikett',
        newForm: 'Neu Formular',
        opdReportFormType: 'Ambulanter Bericht',
        operativePlanFormType: 'Operativer Plan und Bericht',
        otherOptionLabel: 'Andere Moglichkeit Etikett',
        patientFormType: 'Patient',
        property: 'Eigentum',
        radio: 'Funk',
        select: 'Hinabfallen',
        socialworkFormType: 'Sozial Werk',
        text: 'Wortlaut',
        textarea: 'Korpulent Wortlaut',
