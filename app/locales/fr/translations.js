  ...
  admin: {
    ...
    customForms: {
      ...
      labels: {
        ...
        colSpan: 'Nombre de colonne fusionné',
        columns: 'Colonne',
        customForm: 'Formulaire personnalisé',
        dischargeReportFormType: 'Rapport de sortie',
        expenseTo: '',
        ...
        socialworkFormType: '',
        text: 'Texte',
        textarea: 'Large texte',
        visitFormType: ''
      },
      messages: { formSaved: 'Le formulaire {{name}} a été sauvegardé' },
      titles: {
        checkboxValues: 'Valeurs des cases à cocher',
        customForms: 'Formulaires personnalisés',
        deleteForm: 'Supprimer formulaire personnalisé',
        dropDownValues: 'Valeurs du menu déroulant',
        editCustomForm: 'Editer le formulaire personalisé',
        fields: 'Champs',
        formSaved: 'Formulaire sauvegardé',
        newCustomForm: 'Nouveau formulaire personnalisé',
        radioValues: 'Valeurs des boutons radios'
      }
    },
    header: {
      editTitle: '',
      ...
      logoURL: 'URL du logo',
      messages: { headerSaved: 'Entête sauvegardé' },
      newTitle: 'Nouveau titre',
      titles: { optionsSaved: 'Options sauvegardés' }
    },
    ...
    workflow: {
      ...
      editTitle: 'Flux de travail',
      followupPrepaymentLabel: '',
      messages: { optionsSaved: 'Les options du flux de travail ont été sauvegardées' },
