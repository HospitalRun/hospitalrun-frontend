export default {
  admin: {
    ...
    lookup: {
      ...
      alertImportListUpdateMessage: 'La lista de búsqueda ha sido salvada.',
    ...
    roles: {
      capability: {
        ...
        addIncidentCategory: 'Agregar categoria de incidente',
        ...
        addSocialwork: 'Agregar trabajo social',
        ...
        generateIncidentReport: 'Generar reporte de incidente',
        imaging: 'Radiografia',
        incident: 'Incidente',
  ...
  buttons: {
    ...
    addLineItem: 'Agregar linea de item',
  ...
  incident: {
    ...
    titles: {
      ...
      addCategoryItem: 'Agregar categoría',
      addNote: 'Agregar nota',
      ...
      deleteIncident: 'Eliminar incidente',
      deleteIncidentCategory: 'Eliminar categoria de incidentes',
      deleteItem: 'Eliminar item',
      deleteNote: 'Eliminar nota',
      editAttachment: 'Editar adjunto',
      editIncident: 'Editar incidente',
      editIncidentCategory: 'Editar categoria de incidentes',
      editNote: 'Editar nota',
      general: 'General',
      history: 'Historia',
      incidentCategories: 'Categoría de incidentes',
      ...
      newIncidentCategory: 'Nueva categoria de incidentes',
      notes: 'Notas',
      reports: 'Reportes'
    }
  },
  inventory: {
    ...
    labels: {
      ...
      giftInKindNo: 'N',
      giftInKindYes: 'Y',
      giftUsage: 'Uso del regalo/obsequio',
      ...
      vendor: 'Proveedor',
      vendorItemNumber: 'Número de ítem de proveedor',
    ...
    messages: {
      ...
      warning: 'Compruebe los campos requeridos (marcados con *) y corrija los errores antes de Agregar.'
    },
    reports: {
  ...
  labs: {
    ...
    messages: {
      ...
      noItemsFound: 'No se encontraron laboratorios.'
    },
  ...
  medication: {
    alerts: {
      ...
      savedMessage: 'La devolución de medicación ha sido guardada.',
    ...
    labels: {
      ...
      returnReason: 'Razón por la que se devuelve/Nota'
    },
  ...
  messages: {
    ...
    noNotesAvailable: 'No hay notas clínicas adicionales disponibles para esta visita.',
    noUsersFound: 'Ningún usuario encontrado.',
    onBehalfOf: 'a nombre de',
    reportError: 'Reporte de error',
  ...
  operativePlan: {
    ...
    labels: {
      additionalNotes: 'Notas adicionales',
      admissionInstructions: 'Instrucciónes de admisión',
      caseComplexity: 'Complejidad del caso',
      completedStatus: 'Estado completado',
      droppedStatus: '',
      operationDescription: 'Descripción de la operación',
      plannedStatus: 'Estado planeado',
      status: 'Estado',
      surgeon: ''
    },
    messages: {
      planCompleted: 'El plan fue completado con éxito.',
      planSaved: 'El plan fué guardado con éxito.'
    },
    titles: {
      editTitle: 'Editar titulo',
      newTitle: 'Nuevo titulo',
  ...
  patients: {
    buttons: {
      ...
      patientCheckIn: 'CheckIn Paciente',
      scheduleSurgery: ''
    },
    labels: {
      admissionDate: '',
      ...
      cost: 'Costo',
      dateOfBirth: 'Fecha de nacimiento',
      dateProcessed: 'Fecha de procesado',
      dischargeDate: '',
      dob: '',
      education: 'Educación',
      email: 'Correo electrónico',
      externalPatientId: 'Código externo de paciente',
      ...
      referredDate: 'Fecha de referencia',
      relationship: 'Relación',
      relationships: 'Relaciones',
      religion: 'Religion',
      secondaryDiagnosis: 'Diagnostico secundario',
      sex: 'Sexo',
      sexNotEntered: 'Sexo no ingresado',
      sources: '',
      status: 'Estado',
      totalMontlyExpense: ''
    },
    messages: {
      areYouSureDelete: 'Esta seguro de eliminar?',
      createNewPatient: 'Crear nuevo paciente',
      deletingPatient: 'Eliminando paciente',
      noPatientsFound: 'No se encontraron pacientes',
      notFoundQuickAdd: '',
      photoFileRequired: 'Imagen requerida',
    ...
    navigation: {
      ...
      general: 'General',
      history: 'Historia',
      imaging: 'Diagnostico por Imagenes',
      labs: 'Laboratorios',
      medication: 'Medicación',
      photos: 'Fotos',
      socialWork: '',
    ...
    titles: {
      ...
      admissionsDetail: 'Detalles de admisiónes',
      admissionsSummary: 'Sumario de admisiones',
      admittedPatients: 'Pacientes admitidos',
      'delete': 'Eliminar',
      deleteContact: 'Eliminar contacto',
      deleteExpense: 'Eliminar expensa',
      deleteFamilyMember: 'Eliminar miembro familiar',
      ...
      patientListing: '',
      patientReport: '',
      patientStatus: 'Estado de paciente',
      proceduresDetail: '',
      proceduresSummary: '',
      savedPatient: 'PAciente guardado',
      socialWork: '',
  ...
  vitals: { labels: {
    ...
    heartRate: '',
    height: '',
    respiratoryRate: 'Tasa de respiración',
    sbp: '',
