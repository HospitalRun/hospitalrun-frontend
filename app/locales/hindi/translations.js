  ...
  admin: {
    ...
    customForms: {
      buttons: {
        ...
        moveDown: 'नीचे की ओर',
        moveUp: 'बढ़ाना',
        newForm: 'नए प्रपत्र मे',
        preview: 'पूर्वावलोकन'
      },
      labels: {
        alwaysInclude: 'हमेशा शामिल करें',
        checkbox: 'चेकबॉक्स',
        colSpan: 'कॉलम की संख्या अवधि के लिए',
        columns: 'कॉलम',
        customForm: 'कस्टम फॉर्म',
        dischargeReportFormType: 'निर्वहन रिपोर्ट',
        expenseTo: 'खर्च करने के लिए',
        formName: 'फ़ार्म का नाम',
        formType: 'Form Type',
        incidentFormType: 'घटना',
        includeOtherOption: 'अन्य विकल्प शामिल करें',
        labFormType: 'प्रयोगशाला',
        label: 'लेबल',
        newForm: 'नए रूप मे',
        opdReportFormType: 'आउट पेशेंट रिपोर्ट',
        operativePlanFormType: 'ऑपरेटिव योजना और रिपोर्ट',
        otherOptionLabel: 'अन्य विकल्प लेबल',
        patientFormType: 'मरीज',
        property: 'संपत्ति',
        radio: 'रेडियो',
        select: 'ड्रॉप डाउन',
